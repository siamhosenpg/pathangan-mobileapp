...
const BackHeader = () => {
  ...
  return (
    <TouchableOpacity
      onPress={() => router.back()}
      className="bg-background dark:bg-dark-background border-b border-border/60 dark:border-dark-border/60 px-4 p-4 flex-row items-center gap-3  justify-center"
    >
